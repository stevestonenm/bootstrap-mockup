...
<html>
	...
	<body>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="https://www.fillmurray.com/" target="_blank">Bill</a></li>
							<li><a href="http://www.bobrosslipsum.com/index.html" target="_blank">Bob</a></li>
							<li><a href="https://placekitten.com/" target="_blank">Meow</a></li>
						</ul>
					</div><!-- /.navbar-collapse -->
				</div><!-- /.container-fluid -->
			</nav>
		...
		<div class="jumbotron">
			<div class="container">
				<h1>Hey Bobby!</h1>
				<p>This is a reference to Bill Murray in "What About Bob". It is one of the best movies ever made.</p>
